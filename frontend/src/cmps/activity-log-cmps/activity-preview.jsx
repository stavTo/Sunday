	...
	switch (action.type) {
		...
		case RENAME_TASK:
			return (
				<div className="dynamic-cmp">
					{action.oldTaskTitle}
					<div className="arrow">{ICON_EXPAND_ARROW}</div> {action.nameTaskTitle}
				</div>
			)
		case DUPLICATE_TASK:
			return (
				...
				<div className="dynamic-cmp flex align-center">
					<TippyContainer txt={action.fromLabel.title}>
						<div
							...
							style={{ backgroundColor: action.fromLabel.color }}
						>
					...
					<TippyContainer txt={action.toLabel.title}>
						<div className="new-label flex align-center" style={{ backgroundColor: action.toLabel.color }}>
					...
					<div className="timeline-container">
						<div className="span-container flex align-center justify-center">
							...
							<div
								...
								style={{
									backgroundColor: action.groupColor,
									borderRadius: '5em',
									width: '80px',
									height: '20px',
								}}
